...
exports.handleReply = async function(o) {
    ...
    if (_.type == 'player_vs_bot') {
        ...
        }else send(`${random_word_}`, (err, res)=>(res.type = 'player_vs_bot', res.name = exports.config.name, res.event = o.event, res.word_bot = random_word_, res.loop = _.loop+1, res.bet = _.bet, client.handleReply.push(res)));
    };
