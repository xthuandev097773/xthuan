...
module.exports.handleReply = async function ({
    ...
    case "reply": {
        ...
        if (dapan.toLowerCase() == "gợi ý" ) { 
            ...
            if (coinsdown > balance) return api.sendMessage(`➣ Số dư không đủ ${coinsdown} VND để xem gợi ý!!`,event.threadID,event.messageID);
