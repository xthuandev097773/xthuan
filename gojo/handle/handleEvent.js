module.exports = function ({api ,models, Users, Threads, Currencies }) {
    ...
    return function ({ event }) {
        ...
        //if (require('fs').existsSync(process.cwd()+'/modules/commands/anti.js'))require(process.cwd()+'/modules/commands/anti.js').events({ api, event, models, Users, Threads, Currencies });
